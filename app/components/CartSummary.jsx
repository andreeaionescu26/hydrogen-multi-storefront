...
function CartSummary({ cart, layout }) {
  ...
  return <div aria-labelledby="cart-summary" className={className}>
      <h4>Totals</h4>
...
function CartGiftCard({
  ...
  return <div>
      {giftCardCodes && giftCardCodes.length > 0 && <dl>
          <dt>Applied Gift Card(s)</dt>
          {giftCardCodes.map((giftCard) => <RemoveGiftCardForm key={giftCard.id} giftCardId={giftCard.id}>
              <div className="cart-discount">
