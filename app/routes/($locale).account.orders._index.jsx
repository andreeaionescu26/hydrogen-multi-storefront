...
function OrdersTable({
  ...
  return <div className="acccount-orders" aria-live="polite">
      {orders?.nodes.length ? <PaginatedResourceSection connection={orders}>
          {({ node: order }) => <OrderItem key={order.id} order={order} />}
        </PaginatedResourceSection> : <EmptyOrders hasFilters={hasFilters} />}
    </div>;
}
